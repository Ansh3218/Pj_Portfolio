...
export const videos = [
  ...
  {
    videoSrc:
      "https://www.dropbox.com/scl/fi/c8atah2uq3areboi98mof/JEE-SAMPLE.mp4?rlkey=n4im7orsqtslzkxaqclnylxri&st=m3loaejs&raw=1",
    title: "Landscape Video 2",
    text: "Lorem ipsum Landscape 2",
  },
  {
      ...
      <div className="px-[2vw] bg-black">
        ...
        <div className="lol mt-[5vh]">
          {rows.map((rowVideos, idx) => (
            <div
              key={idx}
              className="hero w-full mb-[5vh] flex gap-[2vw] min-h-[70vh] max-sm:min-h-[100vh] max-sm:h-auto"
            >
